...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const postTestScripts = !postTestScriptInput ? undefined : (0, script_parser_1.parseScript)(postTestScriptInput);
            console.log(`Post Test Scripts:`);
            postTestScripts === null || postTestScripts === void 0 ? void 0 : postTestScripts.forEach((script) => __awaiter(this, void 0, void 0, function* () {
                console.log(`${script}`);
            }));
